...
- **THEN** it must contain sections for macOS version, disk map (internal vs external), free space, OrbStack configured resources (CPU/RAM), and current bottlenecks
